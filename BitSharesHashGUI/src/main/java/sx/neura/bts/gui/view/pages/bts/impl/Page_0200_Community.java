...
public class Page_0200_Community extends Page_Bts {
	
	private static Page_0200_Community instance;
	
	@FXML
	private Label introUI;

	public static Page_0200_Community getInstance() {
		if (!isInstance())
			instance = new Page_0200_Community();
		return instance;
	}
