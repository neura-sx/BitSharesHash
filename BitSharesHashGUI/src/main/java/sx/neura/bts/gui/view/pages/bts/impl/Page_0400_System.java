...
public class Page_0400_System extends Page_Bts {
	
	private static Page_0400_System instance;
	
	@FXML
	private Label introUI;

	public static Page_0400_System getInstance() {
		if (!isInstance())
			instance = new Page_0400_System();
		return instance;
	}
