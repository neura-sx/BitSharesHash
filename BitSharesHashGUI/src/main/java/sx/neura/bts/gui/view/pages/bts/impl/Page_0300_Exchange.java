...
public class Page_0300_Exchange extends Page_Bts {
	
	private static Page_0300_Exchange instance;
	
	@FXML
	private Label introUI;

	public static Page_0300_Exchange getInstance() {
		if (!isInstance())
			instance = new Page_0300_Exchange();
		return instance;
	}
