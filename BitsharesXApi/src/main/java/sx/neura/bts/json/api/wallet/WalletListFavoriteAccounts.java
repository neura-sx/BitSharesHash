...
public class WalletListFavoriteAccounts extends CommandJson {
	...
	private static final String COMMAND = "wallet_list_favorite_accounts";
	...
	public static List<Account> run(int id) throws BTSSystemException {
		WalletListFavoriteAccounts i = (WalletListFavoriteAccounts) new WalletListFavoriteAccounts().doRun(
				id, COMMAND);
