...
public class MarketOrderBidAskTile extends Tile<CumulativeMarketOrder> {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		if (item != null) {
			...
			if (item.getOrder().getType().equals("bid_order"))
				cumulativeUI.setText(getAmount(assetBase, (long) (item.getCumulative() / item.getOrder().getMarket_index().getOrder_price().getRatio())));
			else if (item.getOrder().getType().equals("ask_order"))
