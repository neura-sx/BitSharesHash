...
public class Module_Otxs extends Module {

	private static Module_Otxs instance;

	public static Module_Otxs getInstance() {
		if (!isInstance())
			instance = new Module_Otxs();
		return instance;
	}
	...
	protected void initialize() {
		...
		screens.add(new Chart(SampleCharts.createPieChart()));
		screens.add(new Web("Shark"));
		screens.add(new Web("Kiwi"));
