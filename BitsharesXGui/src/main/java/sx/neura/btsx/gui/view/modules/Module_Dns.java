...
public class Module_Dns extends Module {

	private static Module_Dns instance;

	public static Module_Dns getInstance() {
		if (!isInstance())
			instance = new Module_Dns();
		return instance;
	}
	...
	protected void initialize() {
		...
		screens.add(new PageManager(this, new Web("Fortaleza")));
		screens.add(new Chart(SampleCharts.createScatterChart()));
		screens.add(new Web("Surrender"));
